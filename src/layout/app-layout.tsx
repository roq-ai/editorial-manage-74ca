...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'author', 'editor', 'editorin-chief', 'reviewer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Edits', path: '/edits', entity: 'edit', service: AccessServiceEnum.PROJECT, icon: FiEdit2 },
    { name: 'Papers', path: '/papers', entity: 'paper', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Publications',
      path: '/publications',
      entity: 'publication',
