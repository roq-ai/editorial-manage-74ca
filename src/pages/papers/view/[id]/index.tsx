...
import { getPaperById } from 'apiSdk/papers';
import { PaperInterface } from 'interfaces/paper';
import { EditListPage } from 'pages/edits';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('paper', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/papers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Plagiarism Check" text={data?.plagiarism_check} />

                <FormListItem label="Relevancy Check" text={data?.relevancy_check} />
