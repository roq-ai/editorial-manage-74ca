  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock seamless publication with Editorial Management System, where authorship meets innovation. Post, check, review, edit and approve papers in one streamlined process."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1617659258448-f2711883be96?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZGl0b3JpYWx8ZW58MHx8fHwxNjkzNTM5Nzc5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@mathildelangevin?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock seamless publication with Editorial Management System, where authorship meets innovation. Post, check, review, edit and approve papers in one streamlined process.`}
            </Text>
            <Box
