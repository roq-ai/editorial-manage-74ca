...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'paper.create': {
    ...
    key: 'paper-submitted',
    tenantPath: ['organization', 'user', 'paper'],
    userPath: [],
  },
  'review.create': {
    roles: ['admin', 'author'],
  ...
  'edit.create': {
    roles: ['admin', 'editor-in-chief'],
    key: 'paper-edited',
    tenantPath: ['organization', 'user', 'edit'],
    userPath: [],
  },
  'publication.create': {
    roles: ['admin', 'author', 'guest'],
    key: 'paper-published',
    tenantPath: ['organization', 'user', 'publication'],
    userPath: [],
  },
  'paper.delete': {
    roles: ['admin', 'reviewer', 'editor', 'editor-in-chief'],
    key: 'paper-deleted',
    tenantPath: ['organization', 'user', 'paper'],
    userPath: [],
  },
...
const tenantRoles: string[] = ['author', 'editor', 'editorin-chief', 'reviewer'];
